    ...
    return (
        <form className="px-6 " onSubmit={handleSubmit(handleSubmitForm)}>
            <div className="space-y-12 sm:space-y-16">
                <div>
                    <div
                        className="mx-auto flex h-12 mb-6 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 sm:mx-0 sm:h-10 sm:w-10">
                ...
                <div>
                    ...
                    <div
                        className="mt-10 grid grid-cols-1 md:grid-cols-2 md:gap-x-4 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                        ...
                        {/* Privances */}
                        <div
                            className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6  md:grid-cols-2 md:gap-y-1">
                            <label
                                htmlFor="privances"
